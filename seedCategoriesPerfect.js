...
// ==================== 16. BOUTIQUES ====================
{
  ...
  order: 1,
  children: [
    { name: 'Boutique de Véhicules', slug: 'boutique-vehicules', level: 2, emoji: '🚗', order: 1, children: [] },
    { name: 'Boutique de Vêtements', slug: 'boutique-vetements', level: 2, emoji: '👕', order: 2, children: [] },
    { name: "Boutique d'Électroménager", slug: 'boutique-electromenager', level: 2, emoji: '🔌', order: 3, children: [] },
    { name: "Boutique d'Immobilier", slug: 'boutique-immobilier', level: 2, emoji: '🏠', order: 4, children: [] },
    { name: 'Boutique Alimentaire', slug: 'boutique-alimentaire', level: 2, emoji: '🍎', order: 5, children: [] },
    { name: "Boutique d'Emploi", slug: 'boutique-emploi', level: 2, emoji: '💼', order: 6, children: [] },
    { name: "Boutique d'Informatique", slug: 'boutique-informatique', level: 2, emoji: '💻', order: 7, children: [] },
    { name: 'Boutique de Loisirs', slug: 'boutique-loisirs', level: 2, emoji: '🎪', order: 8, children: [] },
    { name: 'Boutique de Matériaux', slug: 'boutique-materiaux', level: 2, emoji: '🧱', order: 9, children: [] },
    { name: 'Boutique de Meubles', slug: 'boutique-meubles', level: 2, emoji: '🛋️', order: 10, children: [] },
    { name: 'Boutique de Pièces Détachées', slug: 'boutique-pieces-detachees', level: 2, emoji: '🔩', order: 11, children: [] },
    { name: 'Boutique de Santé & Beauté', slug: 'boutique-sante-beaute', level: 2, emoji: '💄', order: 12, children: [] },
    { name: 'Boutique de Services', slug: 'boutique-services', level: 2, emoji: '🛠️', order: 13, children: [] },
    { name: 'Boutique de Sport', slug: 'boutique-sport', level: 2, emoji: '⚽', order: 14, children: [] },
    { name: 'Boutique de Voyages', slug: 'boutique-voyages', level: 2, emoji: '✈️', order: 15, children: [] },
    { name: 'Boutique de Téléphone', slug: 'boutique-telephone', level: 2, emoji: '📱', order: 17, children: [] }
  ]
},

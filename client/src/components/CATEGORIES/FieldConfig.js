...
export const DYNAMIC_FIELDS_CONFIG = {
  // ============ ALIMENTAIRES ============
  'alimentaires': {step2: ['title','description', 'reference','livraison' ],step3: ['price','unite','typeOffre','echange','grossdtail'],step4: ['wilaya', 'telephone','email'],step5: ['images']},

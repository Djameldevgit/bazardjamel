...
/* useEffect(() => {
  ...
  /* ════════════════════════════════════════════════════════
     RENDER CON CLASES CSS DEL ARCHIVO DEDICADO
     ════════════════════════════════════════════════════════ */
  return (
              ...
              <Dropdown.Menu className="vr-dropdown-menu">
                {isAdmin && isPending && (
                  <>
                    ...
                    <Dropdown.Divider className="vr-dropdown-divider" />
                  </>
                )}
          ...
          <div className="vr-actions-sidebar">
            ...
            <div className="vr-action-group">
              <button className="vr-action-btn" onClick={handleOpenComments}>
                <FontAwesomeIcon icon={faCommentRegular} className="vr-action-icon" />
              </button>
            ...
            {isLargeScreen && hasPrev && onPreviousVideo && (
              <div className="vr-nav-group">
                <button className="vr-nav-btn" onClick={onPreviousVideo} title="Vidéo précédente">
            ...
            {isLargeScreen && hasNext && onNextVideo && (
              <div className="vr-nav-group">
                <button className="vr-nav-btn" onClick={onNextVideo} title="Vidéo suivante">

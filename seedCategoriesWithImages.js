...
const categoriesData = [
  ...
  },
  {
    ...
    level: 1,
    icon: '/uploads/categories/telephonie-tablettes/level1/telephonie-tablettes.png',
    iconType: 'image-png',
    iconColor: '#2196F3',
    bgColor: '#E3F2FD',
    order: 14,
  ...
  // Si necesitas añadir las 5 categorías internas que mencionas, deberías tener también:
  // (Basándome en tu comentario de "las cinco interiores categorias del archivo base")
